      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Our" in this Agreement) refers to Kings of Shine LLC, 495 Demott Ln, Somerset, NJ 08873.`}
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank" rel="noreferrer">
        ...
        <li>
          <p>
            ...
            {` refers to Kings of Shine, accessible from `}
            <a href="https://kingsofshinellc.com/" rel="external nofollow noopener noreferrer" target="_blank">
              https://kingsofshinellc.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>
            {`By email: `}
            <a
              href="mailto:kingsofshine@outlook.com"
              className="__cf_email__"
              data-cfemail="efa48681889c8089bc8786818aaf809a9b83808084c18c8082">
        ...
        <li>
          <p>
            {`By phone number: `}
            <a href="tel:1-914-217-2507">914.217.2507</a>
          </p>
        </li>
      </ul>
    </Layout>
